...
{
	private static final String CONFIG_FILE_NAME = "keymap/";
...
//				loadedBuiltinStyles = Arrays.asList( createDefaultStyle( "Default" ) );
	...
	{
		System.out.println(  "loadBuiltinStyle" );
		System.out.println(  filename );
		System.out.println(  KeymapManager.class.getResourceAsStream( filename ) );
		System.out.println(  "" );
