...
public class SimilarityTransformInterpolator extends AbstractTransformAnimator
{
	...
	public SimilarityTransformInterpolator(final AffineTransform3D transform, final double[] p) {
		super(1);
